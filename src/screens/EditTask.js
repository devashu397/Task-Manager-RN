    ...
    <Provider>
      <Appbar.Header style={{ backgroundColor: theme.colorAccentPrimary }}>
        ...
        {/* <Appbar.Action
                    ...
                    onPress={() => _panel.show()}
                /> */}
        <Appbar.Action icon="account-multiple-plus" onPress={showDialog} />
      ...
      >
        <Portal>
          ...
          >
            ...
            <Dialog.Actions>
              ...
              <Button onPress={addEmail} color={theme.colorAccentSecondary}>
                Add
              </Button>
            </Dialog.Actions>
          </Dialog>
        ...
        <View>
          ...
          <Text
            onPress={showPicker}
            style={[styles.dateInput, { color: theme.subTextColor }]}
          >
            {chosenDate !== ""
        ...
        >
          ...
          >
            <>
              ...
              <Switch
                value={isChecked}
                onValueChange={() => handleIsCompleted(isChecked)}
                color={theme.colorAccentSecondary}
              />
            </>
          </TouchableRipple>
