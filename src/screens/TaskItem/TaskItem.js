  ...
  return (
    <Provider>
      ...
      <Portal>
        ...
        >
          <Dialog.Content>
            <Text style={{ fontSize: 16 }}>The note will be deleted</Text>
          </Dialog.Content>
          <Dialog.Actions>
            <Button
      ...
      <View style={{ flex: 1, backgroundColor: theme.backgroundColor }}>
        ...
        >
          ...
          {taskTime !== "" && (
            <View>
              <Text style={[styles.taskDate, { color: theme.subTextColor }]}>
          ...
          <FAB.Group
            ...
            actions={[
              ...
              },
              {
                ...
                label: "Edit",
                color: theme.colorAccentSecondary,
                onPress: () => navigation.navigate("EditTask", route.params),
                style: {
                  backgroundColor: theme.backgroundColor,
                },
              },
